...
plt.ylabel("Average complexity score")
plt.annotate(
    r"$\text{Complexity Score}_i = \frac{1}{4} \left( \frac{\text{AvgTags}_i - \mu_{\text{AvgTags}}}{\sigma_{\text{AvgTags}}} + \frac{\text{AvgTechExprLength}_i - \mu_{\text{AvgTechExprLength}}}{\sigma_{\text{AvgTechExprLength}}} + \frac{\text{AvgBodyLength}_i - \mu_{\text{AvgBodyLength}}}{\sigma_{\text{AvgBodyLength}}} + \frac{\text{AvgTitleLength}_i - \mu_{\text{AvgTitleLength}}}{\sigma_{\text{AvgTitleLength}}} \right)$",
    (0, 0),
    (0, -40),
